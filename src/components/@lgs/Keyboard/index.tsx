  ...
  return (
    ...
    >
      <div className="lg-keyboard__contents ff-DIN-Bold">
        <div className="lg-keyboard__item" onClick={onItemTap}>1</div>
        <div className="lg-keyboard__item" onClick={onItemTap}>2</div>
        <div className="lg-keyboard__item" onClick={onItemTap}>3</div>
        <div className="lg-keyboard__item clear" onClick={onClear}></div>
        <div className="lg-keyboard__item" onClick={onItemTap}>4</div>
        <div className="lg-keyboard__item" onClick={onItemTap}>5</div>
        <div className="lg-keyboard__item" onClick={onItemTap}>6</div>
        <div className="lg-keyboard__item sure" onClick={onSureButtonTap}>确定</div>
        <div className="lg-keyboard__item" onClick={onItemTap}>7</div>
        <div className="lg-keyboard__item" onClick={onItemTap}>8</div>
        <div className="lg-keyboard__item" onClick={onItemTap}>9</div>
        <div className="lg-keyboard__item zero" onClick={onItemTap}>0</div>
        <div className="lg-keyboard__item" onClick={onItemTap}>·</div>
      </div>
    </div>
  );
};
